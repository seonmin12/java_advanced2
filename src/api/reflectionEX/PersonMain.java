...
public class PersonMain {
    public static void main(String[] args) throws Exception {
        //클래스 객체 가져오기 (Class.forName() 메소드)
        Class<Person>personClass = (Class<Person>)Class.forName("api.reflectionEX.Person");
        ...
        //동적으로 메서드 가져와서 실행
        p1.getField(); //invoke() 원격 기능을 수행하라, 발생시켜라
        ...
        int staticResult =(int)staticTotal.invoke(null, 100,200); //static이라서 Null
